...
# python "${CREATE_IMAGESET}" --dataset_files "${OUTPUT_DATA_DIR}" --output_dir "data" --train_chunks "2014-06-24-14-20-41,2014-05-14-13-59-05" --val_chunks "2014-05-06-13-14-58"

python src/imdb/calculate_stats.py --lidar_files "data/lidar_2d" --pgm_height "${PGM_HEIGHT}" --pgm_width "${PGM_WIDTH}" --channels "6"